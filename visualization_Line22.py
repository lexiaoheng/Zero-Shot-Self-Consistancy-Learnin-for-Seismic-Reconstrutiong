...
plt.xticks(ticks=np.arange(0, 3200, 616), labels=[round(i,1) for i in np.arange(0, 104, 20)],fontsize=12,fontweight='bold')
...
ax = plt.gca()
ax.add_patch(plt.Rectangle((200, 410), 200, 200, color="blue", fill=False, linewidth=1))
ax.add_patch(plt.Rectangle((2000, 900), 200, 200, color="red", fill=False, linewidth=1))
...
plt.subplot(3,4,5)
plt.imshow(complete_data[410:610, 200:400],cmap='RdGy',vmin=cmin, vmax=cmax,aspect='auto')
plt.yticks(ticks=np.arange(0, 200, 60), labels=[round(i, 2) for i in np.arange(1.64, 2.44, 0.24)],fontsize=12,fontweight='bold')
plt.xticks(ticks=np.arange(0, 200, 46), labels=[round(i, 2) for i in np.arange(6.5, 13, 1.5)],fontsize=12,fontweight='bold')

plt.subplot(3,4,6)
plt.imshow(missed_data[410:610, 200:400],cmap='RdGy',vmin=cmin, vmax=cmax,aspect='auto')
plt.yticks(ticks=np.arange(0, 200, 60), labels=[round(i, 2) for i in np.arange(1.64, 2.44, 0.24)],fontsize=12,fontweight='bold')
plt.xticks(ticks=np.arange(0, 200, 46), labels=[round(i, 2) for i in np.arange(6.5, 13, 1.5)],fontsize=12,fontweight='bold')

plt.subplot(3,4,7)
plt.imshow(ours[410:610, 200:400],cmap='RdGy',vmin=cmin, vmax=cmax,aspect='auto')
plt.yticks(ticks=np.arange(0, 200, 60), labels=[round(i, 2) for i in np.arange(1.64, 2.44, 0.24)],fontsize=12,fontweight='bold')
plt.xticks(ticks=np.arange(0, 200, 46), labels=[round(i, 2) for i in np.arange(6.5, 13, 1.5)],fontsize=12,fontweight='bold')

plt.subplot(3,4,8)
cb_loc = plt.imshow(traditional[410:610, 200:400],cmap='RdGy',vmin=cmin, vmax=cmax,aspect='auto')
plt.yticks(ticks=np.arange(0, 200, 60), labels=[round(i, 2) for i in np.arange(1.64, 2.44, 0.24)],fontsize=12,fontweight='bold')
plt.xticks(ticks=np.arange(0, 200, 46), labels=[round(i, 2) for i in np.arange(6.5, 13, 1.5)],fontsize=12,fontweight='bold')

plt.subplot(3,4,9)
plt.imshow(complete_data[900:1100, 2000:2200],cmap='RdGy',vmin=cmin, vmax=cmax,aspect='auto')
plt.yticks(ticks=np.arange(0, 200, 60), labels=[round(i, 2) for i in np.arange(3.6, 4.4, 0.24)],fontsize=12,fontweight='bold')
plt.xticks(ticks=np.arange(0, 200, 46), labels=[round(i, 2) for i in np.arange(65, 71.5, 1.5)],fontsize=12,fontweight='bold')

plt.subplot(3,4,10)
plt.imshow(missed_data[900:1100, 2000:2200],cmap='RdGy',vmin=cmin, vmax=cmax,aspect='auto')
plt.yticks(ticks=np.arange(0, 200, 60), labels=[round(i, 2) for i in np.arange(3.6, 4.4, 0.24)],fontsize=12,fontweight='bold')
plt.xticks(ticks=np.arange(0, 200, 46), labels=[round(i, 2) for i in np.arange(65, 71.5, 1.5)],fontsize=12,fontweight='bold')

plt.subplot(3,4,11)
plt.imshow(ours[900:1100, 2000:2200],cmap='RdGy',vmin=cmin, vmax=cmax,aspect='auto')
plt.yticks(ticks=np.arange(0, 200, 60), labels=[round(i, 2) for i in np.arange(3.6, 4.4, 0.24)],fontsize=12,fontweight='bold')
plt.xticks(ticks=np.arange(0, 200, 46), labels=[round(i, 2) for i in np.arange(65, 71.5, 1.5)],fontsize=12,fontweight='bold')

plt.subplot(3,4,12)
plt.imshow(traditional[900:1100, 2000:2200],cmap='RdGy',vmin=cmin, vmax=cmax,aspect='auto')
plt.yticks(ticks=np.arange(0, 200, 60), labels=[round(i, 2) for i in np.arange(3.6, 4.4, 0.24)],fontsize=12,fontweight='bold')
plt.xticks(ticks=np.arange(0, 200, 46), labels=[round(i, 2) for i in np.arange(65, 71.5, 1.5)],fontsize=12,fontweight='bold')
